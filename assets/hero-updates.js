...
(function () {
  ...
  var STYLE = [
    ...
    '  color:#ffffff; background:#1e5fa8; border-radius:3px; padding:2px 7px;',
    '}',
  ...
  ready(function () {
    ...
    var others = items.filter(function (it) {
      return it !== newest && it.days <= RECENT_DAYS;
    }).length;
    ...
    more.textContent = others > 0 ? 'ほか' + others + '件 ›' : '更新履歴 ›';
