...
(function () {
  ...
  const PAGES = {
    ...
    '加算まとめ/連携強化加算.html': { category: 'kasan', title: '連携強化加算' },
    ...
    '加算まとめ/自家製剤加算・計量混合調剤加算.html': { category: 'kasan', title: '自家製剤加算・計量混合調剤加算' },
    '加算まとめ/無菌製剤処理加算.html': { category: 'kasan', title: '無菌製剤処理加算' },
    '加算まとめ/分割調剤.html': { category: 'kasan', title: '分割調剤' },
    '加算まとめ/小児特定加算.html': { category: 'kasan', title: '小児特定加算' },
    '加算まとめ/手帳の活用実績が少ない保険薬局.html': { category: 'kasan', title: '手帳の活用実績が少ない保険薬局' },
    '加算まとめ/薬剤調製料.html': { category: 'kasan', title: '薬剤調製料' },
    ...
    '加算まとめ/服用薬剤調整支援料１.html': { category: 'kasan', title: '服用薬剤調整支援料１' },
    ...
    '加算まとめ/在宅患者医療用麻薬持続注射療法加算.html': { category: 'kasan', title: '在宅患者医療用麻薬持続注射療法加算' },
    '加算まとめ/在宅中心静脈栄養法加算.html': { category: 'kasan', title: '在宅中心静脈栄養法加算' },
    '加算まとめ/在宅患者緊急時等共同指導料.html': { category: 'kasan', title: '在宅患者緊急時等共同指導料' },
    '加算まとめ/在宅移行初期管理料.html': { category: 'kasan', title: '在宅移行初期管理料' },
    '加算まとめ/退院時共同指導料.html': { category: 'kasan', title: '退院時共同指導料' },
    '加算まとめ/経管投薬支援料.html': { category: 'kasan', title: '経管投薬支援料' },
    ...
    'チェックリスト/かかりつけ薬剤師_同意取得後_確認チェックリスト.html': { category: 'checklist', title: 'かかりつけ薬剤師 同意取得後の確認チェックリスト' },
    ...
    '改定資料/記載要領_調剤報酬請求書及び明細書2026.html': { category: 'kaitei', title: '記載要領 調剤報酬請求書・明細書' },
